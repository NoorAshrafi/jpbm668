...
<!--Imports-->
<out-xsl:import href="partfax_scripts.xsl"/>
...
<label id="txt.doctype">
				<text xml:lang="de">Mobiler Helppoint Kunde</text>
				<text xml:lang="fr">Clients Help Point Mobile</text>
				<text xml:lang="it">Cliente dell'Help Point Mobile</text>
			</label>
<label id="txt.leer">
				<text xml:lang="de"/>
				<text xml:lang="fr"/>
...
<text xml:lang="de">Reparatur</text>
<text xml:lang="fr">réparation</text>
<text xml:lang="it">riparazione</text>
</label>
...
<text xml:lang="fr">Description de sinistre</text>
...
<!-- NEU BEGIN SCHADENDATEN KOMPLETTIERT -->
                <!-- begin schadendaten -->
				...
				<tr valign="top">
					<td valign="top">
						<!--start-template-body: h-box-->
						<!--start-outer-format: h-box-->
						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten">
							<span class="h-box">
								<table border="0" cellpadding="2" cellspacing="0" id="subtitle-schaden">
									<tr valign="top">
										<!--start-structure: h-box-->
										<!--start-select-child: h-box-->
										<!--start-format-child: v-box-->
										<td valign="top">
											<!--start-template-body: v-box-->
											<!--start-outer-format: v-box-->
											<span class="v-box">
												<table border="0" cellpadding="2" cellspacing="0" id="schaden-daten">
													<!--start-structure: v-box-->
													<!--start-select-child: v-box-->
													<!--start-format-child: caption-->
													<tr valign="top">
													...
													<tr valign="top">
														<td valign="top">
															...
															<!--start-outer-format: h-box-->
															<span class="h-box">
																<table border="0" cellpadding="2" cellspacing="0" id="schaden-info-name">
																	<tr valign="top">
																		<!--start-structure: h-box-->
																		<!--start-select-child: h-box-->
																		<!--start-format-child: label-data-group-->
																		<td valign="top">
																			...
																			<span class="label-data-group">
																				<table border="0" cellpadding="2" cellspacing="0">
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:Nachname">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenNameXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenNameXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:Nachname"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
																		...
																		<td valign="top">
																			...
																			<span class="label-data-group">
																				<table border="0" cellpadding="2" cellspacing="0">
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:Vorname">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenVornameXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenVornameXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:Vorname"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
													...
													<tr valign="top">
														<td valign="top">
															...
															<!--start-outer-format: h-box-->
															<span class="h-box">
																<table border="0" cellpadding="2" cellspacing="0" id="schaden-info-daten">
																	<tr valign="top">
																		<!--start-structure: h-box-->
																		<!--start-select-child: h-box-->
																		<!--start-format-child: label-data-group-->
																		<td valign="top">
																			...
																			<span class="label-data-group">
																				<table border="0" cellpadding="2" cellspacing="0">
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:Strasse">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenStrasseXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenStrasseXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:Strasse"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:PLZ">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenPlzXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenPlzXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:PLZ"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
																		...
																		<td valign="top">
																			...
																			<span class="label-data-group">
																				<table border="0" cellpadding="2" cellspacing="0">
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:Nummer">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenStrassenNrXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenStrassenNrXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:Nummer"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:Ort">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenOrtXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenOrtXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:Ort"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
													...
													<tr valign="top">
														<td valign="top">
															...
															<!--start-outer-format: h-box-->
															<span class="h-box">
																<table border="0" cellpadding="2" cellspacing="0" id="schaden-info-telefon">
																	<tr valign="top">
																		<!--start-structure: h-box-->
																		<!--start-select-child: h-box-->
																		<!--start-format-child: label-data-group-->
																		<td valign="top">
																			...
																			<span class="label-data-group">
																				<table border="0" cellpadding="2" cellspacing="0">
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:PrivatTelefonnummer">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenTelefonPrivatXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenTelefonPrivatXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:PrivatTelefonnummer"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:Email">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenEmailXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenEmailXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:Email"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
																		...
																		<td valign="top">
																			...
																			<span class="label-data-group">
																				<table border="0" cellpadding="2" cellspacing="0">
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:GeschaeftTelefonnummer">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenTelefonGeschaeftXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenTelefonGeschaeftXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:GeschaeftTelefonnummer"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:Mobilenummer">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenTelefonMobileXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenTelefonMobileXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Adresse/order:Mobilenummer"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
													...
													<tr valign="top">
														<td valign="top">
															...
															<!--start-outer-format: h-box-->
															<span class="h-box">
																<table border="0" cellpadding="2" cellspacing="0" id="schaden-info-versicherer">
																	<tr valign="top">
																		<!--start-structure: h-box-->
																		<!--start-select-child: h-box-->
																		<!--start-format-child: label-data-group-->
																		<td valign="top">
																			...
																			<span class="label-data-group">
																				<table border="0" cellpadding="2" cellspacing="0">
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Versicherer">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenVersichererXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenVersichererXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Geschaedigter/order:Versicherer"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
																		...
																		<td valign="top">
																			...
																			<span class="label-data-group">
																				<table border="0" cellpadding="2" cellspacing="0">
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Zeitpunkt">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenZeitpunktXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenZeitpunktXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Zeitpunkt"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Ort">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenOrtschaftXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenOrtschaftXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Ort"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
																		...
																		<td valign="top">
																			...
																			<span class="label-data-group">
																				<table border="0" cellpadding="2" cellspacing="0">
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:SchadendatumMutiert">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenDatumMutiertXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenDatumMutiertXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:SchadendatumMutiert"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
													...
													<tr valign="top">
														<td valign="top">
															...
															<!--start-outer-format: h-box-->
															<span class="h-box">
																<table border="0" cellpadding="2" cellspacing="0" id="party-information-schadenart">
																	<tr valign="top">
																		<!--start-structure: h-box-->
																		<!--start-select-child: h-box-->
																		<!--start-format-child: label-data-group-->
																		<td valign="top">
																			...
																			<span class="label-data-group">
																				<table border="0" cellpadding="2" cellspacing="0">
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Schaetzer">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenSchaetzerXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenSchaetzerXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Schaetzer"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Verletzte">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenVerletzteXML']"/>
																									
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing OptionVerletzt-->
																									<out-xsl:apply-templates mode="get-code" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Verletzte">
																										<out-xsl:with-param name="id">OptionVerletzt</out-xsl:with-param>
																									</out-xsl:apply-templates>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																		...
																		<td valign="top">
																			...
																			<span class="label-data-group">
																				<table border="0" cellpadding="2" cellspacing="0">
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Schadenklassifikation">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='Schadensumme']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing Schadensumme-->
																									<out-xsl:apply-templates mode="get-code" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Schadenklassifikation">
																										<out-xsl:with-param name="id">Schadensumme</out-xsl:with-param>
																									</out-xsl:apply-templates>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Behandlungsort">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenBehandlungsortXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenBehandlungsortXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Behandlungsort"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:  HalswirbelsaeulenVerletzung">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='OptionHWS']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing OptionHWS-->
																									<out-xsl:apply-templates mode="get-code" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:  HalswirbelsaeulenVerletzung">
																										<out-xsl:with-param name="id">OptionHWS</out-xsl:with-param>
																									</out-xsl:apply-templates>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
													...
													<tr valign="top">
														<td valign="top">
															...
															<!--start-outer-format: h-box-->
															<span class="h-box">
																<table border="0" cellpadding="2" cellspacing="0" id="party-information-schadenoptional">
																	<tr valign="top">
																		<!--start-structure: h-box-->
																		<!--start-select-child: h-box-->
																		<!--start-format-child: label-data-group-->
																		<td valign="top">
																			...
																			<span class="label-data-group">
																				<table border="0" cellpadding="2" cellspacing="0">
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Rapport">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenDienststelleXML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenDienststelleXML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Rapport"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:Verschulden">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='OptionVerschulden']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing OptionVerschulden-->
																									<out-xsl:apply-templates mode="get-code" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:Verschulden">
																										<out-xsl:with-param name="id">OptionVerschulden</out-xsl:with-param>
																									</out-xsl:apply-templates>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:FahrzeugSchluessel">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='FzSchluesselSchaden']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing FzSchluesselSchaden-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:FahrzeugSchluessel"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
																		...
																		<td valign="top">
																			...
																			<span class="label-data-group">
																				<table border="0" cellpadding="2" cellspacing="0">
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:FahrzeugAbgeschlossen">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='OptionFzAbgeschlossen']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing OptionFzAbgeschlossen-->
																									<out-xsl:apply-templates mode="get-code" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:FahrzeugAbgeschlossen">
																										<out-xsl:with-param name="id">OptionFzAbgeschlossen</out-xsl:with-param>
																									</out-xsl:apply-templates>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:AlarmEingeschaltet">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='OptionAlarm']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing OptionAlarm-->
																									<out-xsl:apply-templates mode="get-code" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:AlarmEingeschaltet">
																										<out-xsl:with-param name="id">OptionAlarm</out-xsl:with-param>
																									</out-xsl:apply-templates>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
													...
													<tr valign="top">
														<td valign="top">
															...
															<!--start-outer-format: h-box-->
															<span class="h-box">
																<table border="0" cellpadding="2" cellspacing="0" id="party-information-schadenbeschreibungl">
																	<tr valign="top">
																		<!--start-structure: h-box-->
																		<!--start-select-child: h-box-->
																		<!--start-format-child: label-data-group-->
																		<td valign="top">
																			...
																			<span class="label-data-group">
																				<table border="0" cellpadding="2" cellspacing="0">
																					...
																					<!--start-format-child: label-data-->
																					<tr valign="top">
																						<out-xsl:if test="/order:Message/order:Body/order:Document/order:Schadendaten/order:SchadenBeschreibung2">
																							<!--start-template-body: label-data-->
																							<!--start-outer-format: label-data-->
																							<span class="label">
																								<td valign="top" width="130" class="label">
																									<!--Process label-->
																									<out-xsl:apply-templates select="$labels/label[@id='schadenBeschreibung2XML']"/>
																								</td>
																								<td valign="top" width="160" class="data">
																									<!--Processing schadenBeschreibung2XML-->
																									<out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Schadendaten/order:SchadenBeschreibung2"/>
																								</td>
																							</span>
																							<!--end-outer-format: label-data-->
																							<!--end-template-body: label-data-->
...
<!-- NEU END SCHADENDATEN KOMPLETTIERT   -->
...
<!-- ist das das komische fragezeichen bei besichtigungszeit bis ??? -->
...
<td valign="top" width="160" class="data">
 ...
 <out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Auftragsdaten/order:Besichtigung/order:BesichtigungsOrt/order:Adresse/order:Nachname"/>
...
<td valign="top" width="160" class="data">
 ...
 <out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Auftragsdaten/order:Besichtigung/order:BesichtigungsOrt/order:Adresse/order:Strasse"/> <out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Auftragsdaten/order:Besichtigung/order:BesichtigungsOrt/order:Adresse/order:Nummer"/>
...
<td valign="top" width="160" class="data">
 ...
 <out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Auftragsdaten/order:Besichtigung/order:BesichtigungsOrt/order:Adresse/order:PLZ"/> <out-xsl:apply-templates mode="format-data" select="/order:Message/order:Body/order:Document/order:Auftragsdaten/order:Besichtigung/order:BesichtigungsOrt/order:Adresse/order:Ort"/>

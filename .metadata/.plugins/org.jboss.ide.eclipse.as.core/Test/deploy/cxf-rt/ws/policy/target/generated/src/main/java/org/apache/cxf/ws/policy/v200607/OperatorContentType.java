...
public class OperatorContentType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "All", namespace = "http://www.w3.org/2006/07/ws-policy", type = JAXBElement.class),
        @XmlElementRef(name = "Policy", namespace = "http://www.w3.org/2006/07/ws-policy", type = Policy.class),
        @XmlElementRef(name = "ExactlyOne", namespace = "http://www.w3.org/2006/07/ws-policy", type = JAXBElement.class),
        @XmlElementRef(name = "PolicyReference", namespace = "http://www.w3.org/2006/07/ws-policy", type = PolicyReference.class)
    })
